...
from hmaker.dialog import DialogConfirmation
from hmaker.activablelist import ActivableList, ActivableListRow, ScrollableActivableList, XActivableList, ActiveManager
...
class MultiContentManager(Gtk.Box):
    def __init__(self, w=600, h=600, parent_window=None):
        ...
        self.add_accelerator(self.button_apply_hosts, "<Control>a", signal="clicked")
